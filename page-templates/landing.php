...
?>
    <div class="main-wrap " id="section-home">
      ...
      <!-- Dynamic all section and shortable--->
      
      <?php
        
         $mealp_current_page_id = get_the_ID();
         $mealp_page_meta = get_post_meta($mealp_current_page_id,'mealp-page-section', true);
         foreach($mealp_page_meta['sections'] as $mealp_page_section):

         	$mealp_section_id = $mealp_page_section['section'];
         	$mealp_section_meta = get_post_meta($mealp_section_id,'mealp-section-type', true);
         	$mealp_section_type = $mealp_section_meta['type'];

         	get_template_part("section-templates/{$mealp_section_type}");
      ...
      this below template part is static way by catching id
    ...
    <?php
     ...
     ?>
    --------------------------->
    <!-- testimonial section this is assignment 
