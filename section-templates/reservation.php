...
<div class="col-md-10 p-5 form-wrap">
    <form action="#">
        ...
        <div class="row justify-content-center">
            <div class="col-md-4">
                <input type="submit" id="reservationnow" class="btn btn-primary btn-outline-primary btn-block"
                       value="Reserve Now">
                <a href="#" target="_blank" id="paynow" style="display: none" class="btn btn-primary btn-outline-primary btn-block" >
                    <?php _e("Complate payment", "mealpractice");?>
                </a>
            </div>
        </div>
    </form>
